<?php
/**
 * Class Shipping Method Sefareshi
 *
 * @version           1.0.0
...
/**
 * Class WC Shipping Method Iran Sefareshi
 *
 * @since   1.0.0
 * @version 1.0.0
 */
class AWSA_Shipping_Method_Sefareshi extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'awsa-sefareshi';
		$this->method_title       = __( 'Sefareshi Post', 'awsa-shipping' );
		$this->method_description = __(
			'Postage is calculated based on the store address in WooCommerce or the shop sellers as the source and the customer address as the destination with the variables of distance, weight, insurance, shipping tax with the tariff of 2020',
			'awsa-shipping'
		);
	...
	public function init_form_fields() {
		...
		$form_fields = array(
			...
			'title' => array(
				...
				'type'        => 'text',
				'placeholder' => __( 'Example: Sefareshi Post', 'awsa-shipping' ),
				'description' => __(
			...
			'default_conditions' => array(
				...
				'type'        => 'checkbox',
				'description' => __(
					'If this option is enabled, this sending method will be deactivated if the customer buys from a store in his own city. Otherwise it is active for all cities',
					'awsa-shipping'
				),
				'default'     => 'yes',
				'desc_tip'    => true,
			...
			'disabled_to_cities' => array(
				...
				'type'        => 'multiselect',
				'description' => __(
					'Select the cities for which you want this submission method to be disabled even if the default condition is correct',
					'awsa-shipping'
				),
			...
			'enabled_to_cities'  => array(
				...
				'type'        => 'multiselect',
				'description' => __(
					'Select the cities for which you want this submission method to be active even if the default condition is not correct',
					'awsa-shipping'
				),
				'class'       => 'wc-enhanced-select',
				'options'     => $cities,
			...
			'max_weight' => array(
				...
				'type'              => 'number',
				'description'       => __(
					                       'Maximum weight for sending shipments (optional)',
					                       'awsa-shipping'
				                       ) . ' | ' . __(
					                       'Note: The Islamic Republic Post sends up to a maximum weight of 5,000 grams with this method',
					                       'awsa-shipping'
				                       ),
