...
/**
 * Class WC Shipping Method Express
 *
 * @since   1.0.0
 * @version 1.0.0
 */
class AWSA_Shipping_Method_Express extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'awsa-express';
		$this->method_title       = __( 'Express delivery', 'awsa-shipping' );
		$this->method_description = __(
			'Allows you to send the parcel by personal courier. This service is activated only if the destination city is the same as the city of origin (store or sellers), through the settings you can price for each city or store, the minimum amount for free shipping, active or inactive and ... Change.',
			'awsa-shipping'
		);
	...
	public function init_form_fields() {
		...
		$form_fields = array(
			...
			'title' => array(
				...
				'type'        => 'text',
				'placeholder' => __( 'Example: Express delivery', 'awsa-shipping' ),
				'description' => __(
