...
<style>
	...
	.aw-notice-success {
		box-shadow: -5px 0px 0px #2ecc71 inset;
		background-color: rgba(143, 231, 60, 0.3);
	}

	.awsa-post-actions-box-properties input,
	.awsa-post-actions-box-properties select {
		width: 100%;
	}
</style>
<div class="aw-form">
	...
	<select name="awsa-post-action[action]" id="awsa-post-action-<?php echo $post_id; ?>" class="awsa-post-action"
			style="width: 100%" data-post-id="<?php echo $post_id; ?>">
	...
	<p style="direction: ltr">
		<button id="awsa-post-ajax-actions-<?php echo esc_attr( $post_id ); ?>"
				class="awsa-post-ajax-actions button button-secondary"
				style=""><?php esc_html_e( 'Run', 'awsa-shipping' ); ?></button>
	</p>
</div>
