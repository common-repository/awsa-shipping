...
/**
 * Class WC Shipping Method Iran Pishtaz
 *
 * @since   1.0.0
 * @version 1.0.0
 */
class AWSA_Shipping_Method_Pishtaz extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->id                 = 'awsa-pishtaz';
		$this->method_title       = __( 'Fast Delivery', 'awsa-shipping' );
	...
	public function init_form_fields() {
		...
		$form_fields = array(
			...
			'title' => array(
				...
				'type'        => 'text',
				'placeholder' => __( 'Example: Fast Delivery', 'awsa-shipping' ),
				'description' => __(
			...
			'max_weight' => array(
				...
				'description'       => __(
					                       ...
					                       'Note: The Islamic Republic Post sends up to a maximum weight of 30,000 grams with this method',
					                       'awsa-shipping'
				                       ),
